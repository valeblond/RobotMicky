...
d = Thread(target=distance, args=(ir))
t.start()
d.start()
...
while (True):
    ...
    if (k['0'] == 1 and q['0'] == 1 and i['0'] == 0):          # When he's found red color
        ...
        lm2.run_to_rel_pos(position_sp=30, speed_sp=600, stop_action="hold")
        sleep(3)
        Sound.beep()
    ...
    if(k['0'] == 2):
        lm.run_to_rel_pos(position_sp=0, speed_sp=0, stop_action="hold")
        lm2.run_to_rel_pos(position_sp=30, speed_sp=700, stop_action="hold")
        sleep(1)
