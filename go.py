...
while (True):
    ...
    if (i['0'] == 1):
        while (cs_black['0'] == False and cs2_black['0'] == False):
            ...
            lm2.run_forever(speed_sp=SpeedPercent(100), stop_action="hold")
            # lm.run_to_rel_pos(position_sp=0, speed_sp=900, stop_action="hold")
            # lm2.run_to_rel_pos(position_sp=15, stop_action="hold")
        lm.run_to_rel_pos(position_sp=0, speed_sp=0, stop_action="hold")
        lm2.run_to_rel_pos(position_sp=3, speed_sp=400, stop_action="hold")
        ...
        lm.run_to_rel_pos(position_sp=3, speed_sp=400, stop_action="hold")
